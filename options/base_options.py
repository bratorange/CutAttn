...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['basic', 'basic_spectral_norm', 'n_layers', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG', type=str, default='resnet_9blocks', choices=['resnet_adain', 'resnet_atn', 'resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
        ...
        parser.add_argument('--no_random_mask', action='store_true', help='Omit the oval mask on the image to mimic the tube occlusion on a laparoscope')
